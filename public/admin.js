...
async function saveQpay(){try{const u=document.getElementById('qpay-user').value.trim();const p=document.getElementById('qpay-pass').value.trim();const c=document.getElementById('qpay-code').value.trim();const en=document.getElementById('qpay-enabled').checked;const bq=document.getElementById('bank-qr').value.trim();const file=document.getElementById('bank-qr-file').files[0];
